...
import { useCreateBlogMutation, useGetAllBlogsQuery } from '../../redux/feature/Endpoint/Endpoint';
import ReactQuill from 'react-quill';
import 'react-quill/dist/quill.snow.css';
import Swal from 'sweetalert2'
import BlogAdminDetail from '../../Components/BlogDetail/BlogAdminDetail';
...
const Blog = () => {
    ...
    const {refetch} = useGetAllBlogsQuery(null)
            ...
            <div className="  flex items-center justify-center">
                <div className="bg-white shadow-lg rounded-lg p-8  max-w-lg w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            className={`w-full py-3 mt-12 rounded-sm text-white font-semibold transition-colors ${loading ? 'bg-gray-400' : 'bg-green-500 hover:bg-green-600'
                                }`}
                            disabled={loading}
                        >
                            {loading ? (
