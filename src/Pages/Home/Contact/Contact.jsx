...
const Contact = () => {
    ...
    return (
        <motion.div ref={ref} variants={variants} initial="initial" animate="animate" className="h-full lg:ml-96 mr-48 max-w-full m-auto flex items-center gap-12">
            <motion.div variants={variants} className="flex-1 flex flex-col gap-10">
                <motion.h1 variants={variants} className="text-8xl font-bold leading-[100px]">Let's work together</motion.h1>
                ...
                <motion.div variants={variants}>
                    <h2>Address</h2>
                    <span className="font-light">Mir Mossharraf Hossain Hall, JU</span>
                </motion.div>
                <motion.div variants={variants}>
                    <h2>Phone</h2>
                    <span className="font-light">01843291218</span>
                </motion.div>
            </motion.div>
